...
<html>
	...
	<title>Andri Rizki Saputra</title>
		...
		<nav class="colorlib-nav" role="navigation">
			<div class="top-menu">
				<div class="container">
					<div class="row">
						<div class="col-md-2">
							<div id="colorlib-logo"><a href="index.html">Profil</a></div>
						</div>
					...
					<div class="container">
						<div class="col-md-12 col-md-offset-0">
							<div class="animate-box">
								<img id="img-bulat" src="images/andri.jpg" alt="">
								<p><b>Andri Rizki Saputra</b></p>
								<p><a href="gallery.html" class="btn btn-primary btn-lg btn-custom">CV</a>
								<a href="gallery.html" class="btn btn-primary btn-lg btn-custom">Portofolio</a></p>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="item">
							<div class="col-md-8 col-md-offset-2">
								<div class="featured-entry">
									<img class="img-responsive" src="images/sistem_pakar_1.jpg" alt="">
								</div>
							</div>
						</div>
						<div class="item">
							<div class="col-md-8 col-md-offset-2">
								<div class="featured-entry">
									<img class="img-responsive" src="images/sistem_pakar_2.jpg" alt="">
								</div>
							</div>
						</div>
						<div class="item">
							<div class="col-md-8 col-md-offset-2">
								<div class="featured-entry">
									<img class="img-responsive" src="images/sistem_pakar_3.jpg" alt="">
								</div>
							</div>
						</div>
						<div class="item">
							<div class="col-md-8 col-md-offset-2">
								<div class="featured-entry">
									<img class="img-responsive" src="images/sistem_pakar_4.jpg" alt="">
								</div>
							</div>
						</div>
					</div>
